...
<td><a href="feedback_delete.php?id=<?php echo $row['feedback_id'];?>"><img src="img/bin.gif"></td>
<td><a href="feedback_edit.php?id=<?php echo $row['feedback_id'];?>"><img src="img/pencil.gif"></a></td>
</tr>
<?php 
}
?>

...
?>	 
    ...
    <tr>
      <td>Request Date</td>
      <td><input name="req_date" type="text" id="req_date" class="validate[required],custom[date]"></td>
    </tr>
	
	    <tr>
      <td>Request Details</td>
      <td><input name="req_details" type="text" id="req_details" class="validate[required]"></td>
    </tr>
    <tr>

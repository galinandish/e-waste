...
<form name="form1"  id="formID" method="post" action="news_update.php">
   <table id="example1" class="table table-bordered table-striped">
    <tr>
      <td>Title</td>
      <td><input name="title" type="text" id="title" value="<?php echo $row['title'];?>" class="validate[required],custom[onlyLetter]"></td>
    </tr>
    <tr>
      <td>Description</td>
